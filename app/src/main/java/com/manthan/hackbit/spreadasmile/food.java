 ...
 */
public class food extends Activity implements AdapterView.OnItemSelectedListener {
    SharedPreferences fooddata;
    Spinner spinner1,spinner2,spinner3;
    String options1[]={"Select","Veg","Non Veg"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter1=new ArrayAdapter<String>(food.this,android.R.layout.simple_spinner_item,options1);
        spinner1=(Spinner) findViewById(R.id.spinner1);
        spinner1.setAdapter(adapter1);
        spinner1.setOnItemSelectedListener(this);
        spinner2=(Spinner) findViewById(R.id.spinner2);
        ArrayAdapter<String> adapter2=new ArrayAdapter<String>(food.this,android.R.layout.simple_spinner_item,options2);
        spinner2.setAdapter(adapter2);
        spinner2.setOnItemSelectedListener(this);
        spinner3=(Spinner) findViewById(R.id.spinner3);
        ArrayAdapter<String> adapter3=new ArrayAdapter<String>(food.this,android.R.layout.simple_spinner_item,options3);
    ...
    public void onItemSelected(AdapterView<?> parent, View view,
        ...
        final SharedPreferences.Editor fooddetail = fooddata.edit();
        ...
        switch(position1){
            case 1:
                fooddetail.putString("type", "vegetarian");
                break;
            case 2:fooddetail.putString("type","nonvegetarian");
                break;
        }
            fooddetail.commit();
        switch(position2){
    ...
    {
        if(fooddata.getString("type","null")=="null"||fooddata.getString("number","null")=="null"||fooddata.getString("area","null")=="null")
            Toast.makeText(this,"Fill all detail",Toast.LENGTH_SHORT).show();
        else {
            switch(fooddata.getString("area","null"))
            {
