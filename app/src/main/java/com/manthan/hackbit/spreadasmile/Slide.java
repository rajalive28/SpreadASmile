...
public void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.jayanagarngo);
                    ...
                    public void onClick(View arg0)
                    {
                        ...
                        if(fooddata.getInt("exists1",0)==1)
                        {
                            switch (tv.getText().toString()) {
                                case "1":Toast.makeText(getBaseContext(),"mesage sent",Toast.LENGTH_SHORT).show();
                                    sm.sendTextMessage("8951038181", null, "Hi My name is" + gen + ". I want to donate clothes for " +clothdata.getString("number","")+ " people and my address is " + area + ". Please contact me on this number " + number, null, null);
                                    break;
                                case "2":Toast.makeText(getBaseContext(),"mesage sent",Toast.LENGTH_SHORT).show();
                                    sm.sendTextMessage("8951038181", null, "Hi My name is" + gen + ". I want to donate clothes for " +clothdata.getString("number","")+ " people and my address is " + area + ". Please contact me on this number " + number, null, null);
                                    break;
                            }
                        }
                        if(fooddata.getInt("exists1",0)==2) {
                            switch (tv.getText().toString()) {
                                case "1":Toast.makeText(getBaseContext(),"mesage sent",Toast.LENGTH_SHORT).show();
                                    sm.sendTextMessage("9620559280", null, "Hi My name is" + gen + ". I want to donate food for " +fooddata.getString("number","")+ " people and my address is " + area + ". Please contact me on this number " + number, null, null);
                                    break;
                                case "2":Toast.makeText(getBaseContext(),"mesage sent",Toast.LENGTH_SHORT).show();
                                    sm.sendTextMessage("9620559280", null, "Hi My name is" + gen + ". I want to donate food for " +fooddata.getString("number","")+ " people and my address is " + area + ". Please contact me on this number " + number, null, null);
                                    break;
